...
graph TD
    ...
    subgraph Layer6["外部依赖 External Dependencies"]
        Browser["Playwright 浏览器<br/>Chromium"]
        AIService["SiliconFlow API<br/>视觉 AI 模型"]
        FileSystem["文件系统<br/>/data/uploads"]
        Database["SQLite 数据库<br/>ui-eye.db"]
    end
